...
| 4  | 24.07.23 | BOJ 14002 | 부분 수열을 만들 때, 자신의 이전 순서가 되는 숫자의 인덱스를 저장하는 dp 테이블을 하나 더 추가!!             |                                         |                                        |         |
| 5  | 24.07.24 | BOJ 11048 | BFS에서 최단경로를 구하는 방식과 동일하게 풂. arr[i][j] += 주변 값들 중 최댓값                   | dp 테이블이 따로 필요하지 않음!                     |                                        |
