...
| 32 | 24.12.31 | [BOJ 1504](https://www.acmicpc.net/problem/1504)   | [다익스트라] 1~N 번 노드까지 최단경로를 찾는 문제 + 지정한 2개의 노드(a, b)를 반드시 지나야함. 답 = `a~b 사이의 거리 + min(1~a + b~N, 1~b + a~N)`      | 오랜만에 다익스트라 풀어서 heapq 사용해서 푸는거 까먹었다.. 예전 풀이 보고 기억남! 뭐든 꾸준히 하자!!                                                                                                               |                                                                                                                                  |         |
