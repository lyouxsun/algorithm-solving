...
| 13 | 24.10.02 | [BOJ 1197](https://www.acmicpc.net/problem/1197)   | [크루스칼 w.유니온 파인드] 유니온 파인드와 크루스칼 알고리즘을 통해 최소 비용 신장 트리(MST)를 구하는 문제!               | 유니온 파인드에서 재귀를 사용하기 때문에 `sys.setrecursionlimit(10**6)` 을 추가해야 한다!                                                                           | 유니온 파인드 알고리즘의 최적화 기법인 **경로 압축**에 대해서 더 공부하자!!                                                                                    |    ✅    |
