...
| 8  | 24.09.25 | [BOJ 2307](https://www.acmicpc.net/problem/2307)   | [다익스트라] 다익스트라로 최단경로의 비용과 경로를 구해야 한다.                                            | 파이썬 때문인지 내 알고리즘 때문인지.. 시간초과 해결이 너무 힘들다ㅠㅠ                      | 다익스트라 알고리즘에서는 주로 연결된 노드만 탐색하기 때문에 인접 리스트가 더 효율적이다.                                                   |    ✅    |
